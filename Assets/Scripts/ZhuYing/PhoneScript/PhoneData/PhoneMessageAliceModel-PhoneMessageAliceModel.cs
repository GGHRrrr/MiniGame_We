...
public partial class PhoneMessageAliceModel {
	...
	public static List<PhoneMessageAliceModel> Configs = new List<PhoneMessageAliceModel>()
	{
		new PhoneMessageAliceModel(1, 1, "2030年9月17日", 1, 0),
		new PhoneMessageAliceModel(2, 3, "在吗在吗？如果在的话请立刻回复我的消息。", 1, 0),
		new PhoneMessageAliceModel(3, 3, "我的处境十分的特殊，希望能得到你的帮助。", 1, 0),
		new PhoneMessageAliceModel(4, 1, "2030年9月18日", 2, 0),
		...
		new PhoneMessageAliceModel(8, 1, "2030年9月22日", 3, 0),
		...
		new PhoneMessageAliceModel(13, 1, "2030年9月27日", 4, 0),
		...
		new PhoneMessageAliceModel(18, 1, "2030年10月2日", 5, 1),
		...
		new PhoneMessageAliceModel(29, 1, "2030年10月5日", 6, 2),
